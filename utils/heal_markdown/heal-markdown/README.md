...
A Rust port of `heal_markdown.py` for restoring PDF-extracted markdown into readable CommonMark.

PDF extraction tools often produce markdown with broken word boundaries, garbled Unicode, repeated headers/footers, and other artifacts. This tool applies a pipeline of heuristic repairs -- Unicode normalization, whitespace cleanup, repeated-line removal, heading restoration, citation stripping, and word-boundary recovery -- to produce clean, readable output.
