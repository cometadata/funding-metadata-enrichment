...
from funding_extraction.benchmark.dataset import GoldDocument, GoldFunder
from funding_extraction.benchmark.matching import (
    greedy_match,
    greedy_match_ids,
    similarity,
)
...
def _merge_gold_funders(funders: List[GoldFunder], threshold: float) -> List[GoldFunder]:
    ...
    from funding_extraction.benchmark.dataset import GoldAward
...
def _merge_pred_funders(funders: List[FunderEntity], threshold: float) -> List[FunderEntity]:
    ...
    from funding_extraction.models import Award
