...
from extract_funding_job import make_output_row, parse_args
...
def test_push_parquet_writes_temp_then_uploads(tmp_path, monkeypatch):
    import extract_funding_job as mod
...
def test_parse_args_commit_batch_size_default():
    from extract_funding_job import parse_args
    args = parse_args([
...
def test_parse_retry_hint_seconds_variants():
    from extract_funding_job import _parse_retry_hint_seconds
