...
# ]
# ///
"""SFT for funding extraction on Llama 3.1 8B with synthetic upsampling."""
...
class FundingSFTDatasetBuilder(SupervisedDatasetBuilder):
    ...
    renderer_name: str = ""
    train_path: str = "sft_train.jsonl"
    synthetic_path: str = "sft_synthetic.jsonl"
...
class CLIConfig:
    ...
    learning_rate: float = 0.0  # 0 = auto
    num_epochs: int = 2
    batch_size: int = 128
    max_length: int = 4096
